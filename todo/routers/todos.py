...
async def get_user_from_cookie(request: Request):
    print("get_user_from_cookie called")
    print("All cookies in request:", dict(request.cookies))
...
user_dependency = Annotated[dict, Depends(get_user_from_cookie)]
...
async def render_add_todo_page(request: Request):
    try:
        ...
        print("Exception in render_add_todo_page:", e)
        return redirect_to_login()
...
async def render_edit_todo_page(request: Request, db: db_dependency, todo_id: int = Path(gt=0)):
    try:
        ...
        print("Exception in render_update_todo_page:", e)
        return redirect_to_login()
### Endpoints ###
